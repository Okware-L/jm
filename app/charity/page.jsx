  ...
  return (
    <div className='min-h-screen bg-gray-100'>
      ...
      <div className='p-5 pt-40 text-black'>
        ...
        {/* Introduction */}
        <div className='mb-8'>
          <h2 className='text-3xl font-semibold mb-4'>Collaborating with Charities: Making a Difference Together</h2>
          <p className='text-lg'>
        ...
        <div className='mb-8'>
          <h2 className='text-3xl font-semibold mb-4'>Collaboration with Charities</h2>
          <p className='text-lg'>
        ...
        <div className='mb-8'>
          <h2 className='text-3xl font-semibold mb-4'>Encouraging Donations</h2>
          <p className='text-lg'>
        ...
        {/* How to Donate */}
        <div className='mb-8'>
          <h2 className='text-3xl font-semibold mb-4'>How to Donate</h2>
          <ol className='list-decimal list-inside text-lg'>
            <li><strong>Visit our website:</strong> You can visit our website&#39;s dedicated donation page, which provides information about the charitable organizations we collaborate with and the causes they support. There, you will find details about the donation process and the different methods available.</li>
            <li><strong>Choose a cause:</strong> Browse through the causes we support and select the one that resonates with you the most. Whether it&#39;s providing education to underprivileged children, supporting medical research, or protecting the environment, choose a cause that reflects your values and aspirations.</li>
            <li><strong>Select a donation method:</strong> We offer various donation methods to ensure convenience and security. You can choose to make a one-time donation or set up recurring donations based on your preference. Our website provides secure payment gateways that protect your financial information.</li>
            <li><strong>Spread the word:</strong> Sharing the importance of giving back and encouraging others to donate can amplify the impact of our collective efforts. Use your social media platforms, word of mouth, or other channels to raise awareness about the causes you support and inspire others to contribute.</li>
          </ol>
        </div>

        {/* The Impact of Your Donations */}
        <div className='mb-8'>
          <h2 className='text-3xl font-semibold mb-4'>The Impact of Your Donations</h2>
          <p className='text-lg'>
        ...
        {/* Transparency Note */}
        <div className='mb-8'>
          <h2 className='text-3xl font-semibold mb-4'>Transparency Note</h2>
          <p className='text-lg'>
