    ...
    <div className="h-[95vh] flex items-center justify-center  text-white">
      <div className="text-center">
        <div className={`mb-8 transition-opacity duration-700 ease-in-out ${fade ? 'opacity-0' : 'opacity-100'}`}>
          ...
          <button className="btn btn-wide rounded-none text-sm transition duration-500 ease-in-out  border-transparent hover:border-gray-900  bg-white text-black hover:bg-white">
          Discover More
          </button>
